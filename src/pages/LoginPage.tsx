        ...
        <div className="space-y-6">
          ...
          <div className="flex items-center">
            <input
              ...
              style={{
                accentColor: rememberMe ? '#1f2937' : '#e5e7eb',
                colorScheme: 'light'
              }}
            />
          ...
          {/* Botão Google */}
          <button className="w-full border border-gray-300 text-gray-900 py-3 rounded-lg font-medium hover:bg-gray-50 transition-colors flex items-center justify-center space-x-2">
